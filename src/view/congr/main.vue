<template>
  <div class="congr">
    ...
    <p class="title_infor" style>My Web3 Soul</p>
    ...
    <div class="cudset_but">
      <button
        @click="$router.push('/mint_select')"
        v-if="UserInfo.mintStatus === 2 && UserInfo.twitterStatus === 1"
      >
        Launch SoulCast NFT
        <span class="FREE">FREE</span>
      </button>
      <button @click="toShare" v-else class="earn_diamond">
        share
